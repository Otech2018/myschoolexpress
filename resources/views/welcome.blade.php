					...
					<!-- START REVOLUTION SLIDER 5.0.7 auto mode -->
						<div id="main-banner-slider" class="rev_slider" data-version="5.0.7">
							<ul>
								...
								<!-- SLIDE1  -->
								<li data-index="rs-280" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-saveperformance="off"  data-title="Welcome to my School Express" data-description="">
									<!-- MAIN IMAGE -->
									...
									<div class="tp-caption" 
										...
										<h5>Welcome To My School Express</h5>
									</div>
									...
									<div class="tp-caption" 
										...
										data-responsive_offset="on" 
										style="z-index: 6; white-space: nowrap;">
										<h1>Let's Make your <span class="p-color">School Journey</span> <br>Easier</h1>
									</div>
									...
									<div class="tp-caption"
										...
										data-splitout="none" 
										data-responsive_offset="on">
										<a href="contact-us.html" class="buy-button p-color-bg">Find a Lodge</a>
									</div>
								...
								<!-- SLIDE2  -->
								<li data-index="rs-18" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/home/slide-2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Education is the Key" data-description="">
									<!-- MAIN IMAGE -->
									...
									<div class="tp-caption" 
										...
										data-responsive_offset="on" 
										style="z-index: 6; white-space: nowrap;">
										<h1 class="center-item">Education is the <span class="p-color">KEY</span> <br>Learn education</h1>
									</div>
								...
								<!-- SLIDE3  -->
								<li data-index="rs-20" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/home/slide-5.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Education is the Backbone" data-description="">
									<!-- MAIN IMAGE -->
									...
									<div class="tp-caption" 
										...
										data-responsive_offset="on" 
										style="z-index: 6; white-space: nowrap;">
										<h5>Meet Your New Coummunity of Successful Students</h5>
									</div>
	        ...
	        <div class="theme-manage-area">
	        	<div class="container">
	        		<div class="item-part float-left item1 p-color-bg">
	        			<h3><i class="fa fa-graduation-cap" aria-hidden="true"></i> LEARN COUSES </h3>
	        		...
	        		<div class="item-part float-left item1 p-color-bg">
	        			<h3><i class="fa fa-bank" aria-hidden="true"></i>  Find a Lodge</h3>
	        			<p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequun- tur magni dolores eos qui ratione </p>
	        			<a href="course-details.html" class="tran3s">Rede more <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
	        		</div>
	        	</div> <!-- /.container -->
