	        ...
	        <div class="theme-manage-area">
	        	<div class="container">
	        		<div class="item-part float-left item1 p-color-bg">
	        			<h3><i class="fa fa-graduation-cap" aria-hidden="true"></i> LEARN ILTS first</h3>
	        		...
	        		<div class="item-part float-left item2">
	        			<img src="images/inner-page/5.jpg" alt="Image">
	        		</div>
	        		<div class="item-part float-left item1 p-color-bg">
	        ...
	        <div class="our-certification">
	        	<div class="container">
	        		...
	        		<div class="row">
	        			<div class="theme-slider">
	        				<div class="item hvr-float-shadow">
		        				<img src="images/inner-page/logo1.jpg" alt="">
		        			</div> <!-- /.item -->

		        			<div class="item hvr-float-shadow">
		        				<img src="images/inner-page/logo2.jpg" alt="">
		        			</div> <!-- /.item -->

		        			<div class="item hvr-float-shadow">
		        				<img src="images/inner-page/logo3.jpg" alt="">
		        			</div> <!-- /.item -->
